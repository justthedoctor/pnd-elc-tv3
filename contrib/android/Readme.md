...
$ adb shell monkey -p org.electrum_pnd.electrum_pnd 1
```
...
```
adb logcat | grep -F "`adb shell ps | grep org.electrum_pnd.electrum_pnd | cut -c14-19`"
```
...
Run electrum with the `-g` switch: `electrum-pnd -g kivy`
...
```
$ adb shell
$ run-as org.electrum_pnd.electrum_pnd ls /data/data/org.electrum_pnd.electrum_pnd/files/data
$ run-as org.electrum_pnd.electrum_pnd cp /data/data/org.electrum_pnd.electrum_pnd/files/data/wallets/my_wallet /sdcard/some_path/my_wallet
```
