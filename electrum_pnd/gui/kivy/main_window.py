...
from electrum_pnd.storage import WalletStorage, StorageReadWriteError
from electrum_pnd.wallet_db import WalletDB
from electrum_pnd.wallet import Wallet, InternalAddressCorruption, Abstract_Wallet
from electrum_pnd.wallet import update_password_for_directory

from electrum_pnd.plugin import run_hook
from electrum_pnd import util
from electrum_pnd.util import (profiler, InvalidPassword, send_exception_to_crash_reporter,
                           format_satoshis, format_satoshis_plain, format_fee_satoshis,
                           maybe_extract_bolt11_invoice, parse_max_spend)
from electrum_pnd.invoices import PR_PAID, PR_FAILED
from electrum_pnd import blockchain
from electrum_pnd.network import Network, TxBroadcastError, BestEffortRequestFailed
from electrum_pnd.interface import PREFERRED_NETWORK_PROTOCOL, ServerAddr
from electrum_pnd.logging import Logger
from electrum_pnd.bitcoin import COIN
...
#Factory.register('InstallWizard', module='electrum_pnd.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_pnd.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_pnd.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_pnd.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_pnd_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_pnd.gui.kivy.uix.screens')
...
from electrum_pnd.util import (NoDynamicFeeEstimates, NotEnoughFunds,
...
if TYPE_CHECKING:
    ...
    from electrum_pnd.plugin import Plugins
...
class ElectrumWindow(App, Logger):
    ...
    def on_qr(self, data: str):
        from electrum_pnd.bitcoin import is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
    ...
    def scan_qr_non_android(self, on_complete):
        from electrum_pnd import qrscanner
        try:
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_pnd.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_pnd.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_pnd_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_pnd_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
    ...
    def get_max_amount(self):
        from electrum_pnd.transaction import PartialTxOutput
