...
#:import _ electrum_pnd.gui.kivy.i18n._
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_pnd.mnemonic import Mnemonic
        from electrum_pnd.old_mnemonic import wordlist as old_wordlist
    ...
    def update_next_button(self):
        from electrum_pnd.keystore import bip39_is_checksum_valid
        text = self.get_text()
        if self.is_bip39:
