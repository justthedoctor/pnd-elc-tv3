...
from electrum_pnd.util import InvalidPassword
from electrum_pnd.address_synchronizer import TX_HEIGHT_LOCAL
from electrum_pnd.wallet import CannotBumpFee, CannotCPFP, CannotDoubleSpendTx
from electrum_pnd.transaction import Transaction, PartialTransaction
from electrum_pnd.network import NetworkException

from electrum_pnd.gui.kivy.i18n import _
from electrum_pnd.gui.kivy.util import address_colors
...
Builder.load_string('''
#:import KIVY_GUI_PATH electrum_pnd.gui.kivy.KIVY_GUI_PATH
