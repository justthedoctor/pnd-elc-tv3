...
from electrum_pnd.invoices import (PR_TYPE_ONCHAIN, PR_TYPE_LN, PR_DEFAULT_EXPIRATION_WHEN_CREATING,
                               PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT,
                               LNInvoice, pr_expiration_values, Invoice, OnchainInvoice)
from electrum_pnd import bitcoin, constants
from electrum_pnd.transaction import tx_from_any, PartialTxOutput
from electrum_pnd.util import (parse_URI, InvalidBitcoinURI, TxMinedInfo, maybe_extract_bolt11_invoice,
...
from electrum_pnd.gui.kivy import KIVY_GUI_PATH
from electrum_pnd.gui.kivy.i18n import _

if TYPE_CHECKING:
    from electrum_pnd.gui.kivy.main_window import ElectrumWindow
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_pnd.util import create_bip21_uri
        amount = self.app.get_amount(self.amount)
