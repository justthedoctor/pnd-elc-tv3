...
from electrum_pnd.util import bh2u, NotEnoughFunds, NoDynamicFeeEstimates
from electrum_pnd.i18n import _
from electrum_pnd.lnchannel import AbstractChannel, PeerState, ChannelBackup, Channel, ChannelState
from electrum_pnd.wallet import Abstract_Wallet
from electrum_pnd.lnutil import LOCAL, REMOTE, format_short_channel_id, LN_MAX_FUNDING_SAT
from electrum_pnd.lnworker import LNWallet
...
class ChannelsList(MyTreeView):
    ...
    def new_channel_dialog(self):
        ...
        if self.parent.network.channel_db:
            ...
            from electrum_pnd.lnworker import hardcoded_trampoline_nodes
