...
from electrum_pnd import WalletStorage, Wallet
...
from electrum_pnd.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui(BaseElectrumGui):
    ...
    def network_dialog(self):
        print("use 'electrum-pnd setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-pnd setconfig' to change your settings")
        return True
