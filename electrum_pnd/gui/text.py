...
from electrum_pnd.gui import BaseElectrumGui
from electrum_pnd import util
from electrum_pnd.util import format_satoshis
from electrum_pnd.bitcoin import is_address, COIN
from electrum_pnd.transaction import PartialTxOutput
from electrum_pnd.wallet import Wallet, Abstract_Wallet
from electrum_pnd.wallet_db import WalletDB
from electrum_pnd.storage import WalletStorage
from electrum_pnd.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_pnd.interface import ServerAddr

if TYPE_CHECKING:
    from electrum_pnd.daemon import Daemon
...
class ElectrumGui(BaseElectrumGui):
    ...
    def __init__(self, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'electrum-pnd create'")
            exit()
