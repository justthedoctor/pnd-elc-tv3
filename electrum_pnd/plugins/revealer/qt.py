...
from electrum_pnd.util import make_dir, InvalidPassword, UserCancelled
from electrum_pnd.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                  WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_pnd.gui.qt.qrtextedit import ScanQRTextEdit
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_pnd.gui.qt.password_dialog import PasswordDialog
