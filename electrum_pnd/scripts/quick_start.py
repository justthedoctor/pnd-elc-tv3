...
from electrum_pnd.wallet import Wallet, create_new_wallet
from electrum_pnd.wallet_db import WalletDB
from electrum_pnd.commands import Commands
from electrum_pnd.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-pnd/testnet as datadir
