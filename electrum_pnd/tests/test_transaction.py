...
from electrum_pnd import transaction, bitcoin
from electrum_pnd.transaction import (convert_raw_tx_to_hex, tx_from_any, Transaction,
...
from electrum_pnd.bitcoin import (deserialize_privkey, opcodes,
